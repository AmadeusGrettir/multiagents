...
public class JadeStarter {
    public static void main(String[] args) {
        Map<String, Class<?>> agents = Map.of(
                "organizer", AgentOrganizer.class,
                "participant1", AgentParticipant.class,
                "participant2", AgentParticipant.class,
                "participant3", AgentParticipant.class,
                "participant4", AgentParticipant.class
        );
